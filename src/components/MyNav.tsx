...
type MixedNavProps = RouteComponentProps & MyNavProps

const MyNav = (props: MixedNavProps) => (
    ...
    <Navbar.Collapse id="responsive-navbar-nav">
      <Nav className="ml-auto">
        ...
        <Link to="/reservations">
          <div className={props.location.pathname === '/reservations' ? 'nav-link active' : 'nav-link'}>
            Reservation
          </div>
        </Link>
      </Nav>
